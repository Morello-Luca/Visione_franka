...
voxel_size = 0.004                              # PARAM TO SETUP
...
filtered_pcd = pcd_downsampled.remove_statistical_outlier(nb_neighbors=420,std_ratio=0.7)
...
filtered_pcd_round = filtered_pcd.remove_radius_outlier(nb_points=200, radius=0.04)
